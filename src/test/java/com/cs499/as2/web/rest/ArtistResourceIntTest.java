...
public class ArtistResourceIntTest {
    ...
    private static final String DEFAULT_ATNAME = "AAAAAAAAAA";
    private static final String UPDATED_ATNAME = "BBBBBBBBBB";

    private static final LocalDate DEFAULT_BDAY = LocalDate.ofEpochDay(0L);
    private static final LocalDate UPDATED_BDAY = LocalDate.now(ZoneId.systemDefault());
    ...
    public void createArtist() throws Exception {
        ...
        assertThat(testArtist.getAtname()).isEqualTo(DEFAULT_ATNAME);
        assertThat(testArtist.getBday()).isEqualTo(DEFAULT_BDAY);
    }
    ...
    public void getAllArtists() throws Exception {
        ...
        restArtistMockMvc.perform(get("/api/artists?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].atname").value(hasItem(DEFAULT_ATNAME.toString())))
    ...
    public void getArtist() throws Exception {
        ...
        restArtistMockMvc.perform(get("/api/artists/{id}", artist.getId()))
            ...
            .andExpect(jsonPath("$.atname").value(DEFAULT_ATNAME.toString()))
    ...
    public void updateArtist() throws Exception {
        ...
        Artist testArtist = artistList.get(artistList.size() - 1);
        assertThat(testArtist.getAtname()).isEqualTo(UPDATED_ATNAME);
        assertThat(testArtist.getBday()).isEqualTo(UPDATED_BDAY);
    }
